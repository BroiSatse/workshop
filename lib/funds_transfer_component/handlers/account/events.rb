      ...
      class Events
        ...
        handle ::Account::Client::Messages::Events::Deposited do |account_deposited|
          ...
          if funds_transfer.deposited?
            logger.info(tag: :ignored) { "Event ignored (Event: #{account_deposited.class.name}, Funds Transfer ID: #{funds_transfer_id}, Withdrawal Account ID: #{account_deposited.account_id})" }
            return
          end
